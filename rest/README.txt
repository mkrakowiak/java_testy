...
http://localhost:8080/restservicedemo/api/book/testBook
Spodziewany rezultat: 
"REST Service is running"

6. W terminalu z klientem bazy danych po wykonaniu View->Refresh Tree powinna pojawić się tabela PUBLIC.BOOK
...
http://localhost:8080/restservicedemo/api/book/{ID}
